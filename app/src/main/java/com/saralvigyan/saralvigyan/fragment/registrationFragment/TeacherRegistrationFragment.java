...
public class TeacherRegistrationFragment extends Fragment {
    ...
    public static final String TAG = TeacherRegistrationFragment.class.getName();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        etConfirmPassword = view.findViewById(R.id.et_teacher_confirm_password);
        cbShowPassword = view.findViewById(R.id.cb_show_password);
        btnRegister = view.findViewById(R.id.btn_teacher_register);
        tvSignInLink = view.findViewById(R.id.tv_teacher_sign_in_link);
        ...
        tvSignInLink.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent teacherLoginIntent = new Intent(getContext(), LoginActivity.class);
        ...
        public void afterTextChanged(Editable editable) {
            switch (view.getId()) {
                ...
                case R.id.et_teacher_password:
                    ...
                    break;
                case R.id.et_teacher_confirm_password:
                    validation.validateConfirmPassword(etPassword, etConfirmPassword);
                    break;
            }
        }
